...
typedef struct iox2_entry_value_h_t iox2_entry_value_h_t;
...
typedef struct IOX2_REPR_ALIGNED(8) iox2_entry_value_storage_t {
    uint8_t internal[48];
} iox2_entry_value_storage_t;

typedef struct iox2_entry_value_t {
    enum iox2_service_type_e service_type;
    struct iox2_entry_value_storage_t value;
    void (*deleter)(struct iox2_entry_value_t*);
} iox2_entry_value_t;

/**
 * The owning handle for `iox2_entry_value_t`. Passing the handle to a function transfers the ownership.
 */
typedef struct iox2_entry_value_h_t *iox2_entry_value_h;
 ...
 */
typedef const iox2_entry_value_h *iox2_entry_value_h_ref;
...
void iox2_entry_handle_mut_loan_uninit(iox2_entry_handle_mut_h entry_handle_mut_handle,
                                       struct iox2_entry_value_t *entry_value_struct_ptr,
                                       iox2_entry_value_h *entry_value_handle_ptr,
                                       size_t value_size,
...
void iox2_entry_value_mut(iox2_entry_value_h_ref entry_value_handle,
                          void **value_ptr)
;
...
void iox2_entry_value_update(iox2_entry_value_h entry_value_handle,
...
void iox2_entry_value_discard(iox2_entry_value_h entry_value_handle,
                              struct iox2_entry_handle_mut_t *entry_handle_mut_struct_ptr,
                              iox2_entry_handle_mut_h *entry_handle_mut_handle_ptr)
;
...
void iox2_entry_value_drop(iox2_entry_value_h entry_value_handle)
;
